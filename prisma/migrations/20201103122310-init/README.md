# Migration `20201103122310-init`

This migration has been generated by Aymeric Giraudet at 11/3/2020, 1:23:10 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TABLE "public"."Picross" (
"id" SERIAL,
...
ALTER TABLE "public"."Picross" ADD FOREIGN KEY("authorId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE
```
