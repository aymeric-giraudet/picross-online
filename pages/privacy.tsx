const Privacy: React.FC = () => (
  <>
    <h1>Privacy Policy for Picross Online</h1>

    <p>
      At Picross Online, accessible from https://picross-online.now.sh, one of
      ...
      Picross Online and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Picross Online. This policy is not applicable to any
    ...
    <p>
      Picross Online follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, Picross Online uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of Picross Online.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Picross Online, which are sent
    ...
    <p>
      Note that Picross Online has no access to or control over these cookies
    ...
    <p>
      Picross Online's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Picross Online does not knowingly collect any Personal Identifiable
