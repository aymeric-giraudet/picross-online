const TermsOfService: React.FC = () => (
  <>
    ...
    <p>
      By accessing this Website, accessible from https://picross-online.now.sh,
      ...
      protected by copyright and trade mark law. These Terms of Service has been
    ...
    <p>
      ...
      Picross Online's Website for personal, non-commercial transitory viewing
    ...
    <ul>
      ...
      <li>
        attempt to reverse engineer any software contained on Picross Online's
        Website;
      </li>
      <li>
    ...
    <p>
      This will let Picross Online to terminate upon violations of any of these
    ...
    <p>
      All the materials on Picross Online’s Website are provided "as is".
      Picross Online makes no warranties, may it be expressed or implied,
      therefore negates all other warranties. Furthermore, Picross Online does
    ...
    <p>
      Picross Online or its suppliers will not be hold accountable for any
      damages that will arise with the use or inability to use the materials on
      Picross Online’s Website, even if Picross Online or an authorize
    ...
    <p>
      The materials appearing on Picross Online’s Website may include technical,
      typographical, or photographic errors. Picross Online will not promise
      that any of the materials in this Website are accurate, complete, or
      current. Picross Online may change the materials contained on its Website
      at any time without notice. Picross Online does not make any commitment to
    ...
    <p>
      Picross Online has not reviewed all of the sites linked to its Website and
      is not responsible for the contents of any such linked site. The presence
      of any link does not imply endorsement by Picross Online of the site. The
    ...
    <p>
      Picross Online may revise these Terms of Use for its Website at any time
    ...
    <p>
      Any claim related to Picross Online's Website shall be governed by the
